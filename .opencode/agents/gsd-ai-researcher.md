...
<required_reading>
Read `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
