...
INSTALL_JS_GLOBAL="/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
