...
```
Task(
  prompt="Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/templates/VALIDATION.md`
