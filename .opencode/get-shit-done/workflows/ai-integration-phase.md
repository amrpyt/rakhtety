...
<required_reading>
@/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/references/ai-frameworks.md
@/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/agents/gsd-eval-planner.md for instructions.
