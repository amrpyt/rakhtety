...
```bash
INIT=$(node "/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.opencode/get-shit-done/templates/spec.md.
