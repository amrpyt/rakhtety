...
Key references:
- @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
cp "D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/USER-PROFILE.md" "D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Added profile section to D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/USER-PROFILE.md
```
