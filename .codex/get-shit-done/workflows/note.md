...
- **Global scope**: `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/notes/`)
...
2. Glob `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/notes/` — works in any directory
