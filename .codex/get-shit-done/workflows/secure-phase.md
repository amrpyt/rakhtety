...
```
Task(
  prompt="Read /home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/amr/Coding/Tracking-sys-UsingVanilaCoding/.codex/get-shit-done/templates/SECURITY.md`
