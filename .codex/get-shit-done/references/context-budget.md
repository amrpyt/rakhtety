...
The keys live in `.codex/settings.json` (project) or `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/settings.json` (global) — **not** in `.planning/config.json`:
