...
- **Global scope**: `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/notes/`)
...
2. Glob `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/notes/` — works in any directory
