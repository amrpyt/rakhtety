...
<execution_context>
@D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/workflows/spike.md
...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of {{GSD_ARGS}} as the idea to the spike workflow from @D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/workflows/spike.md end-to-end.
