...
<required_reading>
Read `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
