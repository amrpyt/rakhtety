...
Reference full template: `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/templates/state.md`.
