...
@D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Vibe Coding/02-Real PRojects with Clints/رخصتي/.codex/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
